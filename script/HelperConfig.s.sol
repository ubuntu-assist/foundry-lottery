...
contract HelperConfig is Script, CodeConstants {
    ...
    mapping(uint256 chainId => NetworkConfig localNetworkConfig)
        public chainIdToNetworkConfig;
    ...
    function getConfigByChainId(
        ...
        } else revert HelperConfig__InvalidChainId(chainId);
    }
    ...
    function getSepoliaEthConfig() public pure returns (NetworkConfig memory) {
        return
            NetworkConfig({
                ...
                subscriptionId: 99712634379878651553418661465969334652029374145198140858502975980026961826393,
                callbackGasLimit: 500000,
                link: 0x779877A7B0D9E8603169DdbD7836e478b4624789,
                account: 0xF50d86e711390e529410419fB62376A71956D1C0
            });
    }
